...
from pretrain.model import ReconModel, BaseModel
...
def demonstrate_fixed_hyperparameters():
    """
    演示使用固定超参数的门控机制
    """
    ...
    input_ids = torch.tensor([[1, 3, 3, 3, 2], [1, 3, 3, 3, 2]])
    prefix_mask = torch.ones(batch_size, 5)
...
if __name__ == "__main__":
    demonstrate_fixed_hyperparameters()
    print()
