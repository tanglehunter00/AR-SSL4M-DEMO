...
def analyze_gradient_flow():
    ...
    # 分析梯度传播
    print("4. 梯度传播公式:")
    print("   dL/dgate_weight = dL/dgated_output * dgated_output/dgate_weight")
    print("   dgated_output/dgate_weight = sigmoid'(gate_weight) * (dilated_attention - original_attention)")
    print("   dL/doriginal_attention = dL/dgated_output * (1 - gate)")
    print("   dL/ddilated_attention = dL/dgated_output * gate")
    print()
